namespace cashAccounting.Migrations
{
    ...
    public partial class Migration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Category = c.String(),
                        DateConsumption = c.DateTime(nullable: false),
                        Comment = c.String(),
                ...
                c => new
                    {
                        ...
                        Sum = c.Double(nullable: false),
                        Category = c.String(),
                        DateIncome = c.DateTime(nullable: false),
                        Comment = c.String(),
                        User_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Consumptions", "User_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Consumptions", new[] { "User_Id" });
