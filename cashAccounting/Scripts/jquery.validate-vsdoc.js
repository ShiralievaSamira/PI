...
$.extend($.validator, {
	...
	messages: {
        ...
        remote: "Поле заполнено некорректно.",       //Please fix this field
        ...
        creditcard: "Пожалуйста, введите действительный номер банковской карты.",
		equalTo: "Пожалуйста, введите то же значение еще раз.",
        accept: "Пожалуйста, введите значение с действительным расширением.",
		...
		rangelength: $.validator.format("Пожалуйста, введите значение от {0} до {1}."),
